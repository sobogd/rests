...
//         name: c.name,
//         description:
//           c.description?.replaceAll(" ", "") !== "" ? c.description : undefined,
//         positions: [],
//       };
//
...
//       const positionsForCategory = positions.filter((po) =>
//         positionsForCategoryIds.includes(po.id)
//       );
//
